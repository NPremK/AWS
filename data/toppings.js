...
function init () {
  create('Dough Crust', 'dough_crust.png', 'dough_crusts.png', 1)
  create('Marinara Sauce', 'marinara_sauce.png', 'marinara_sauces.png', 2)
  create('Mozzarella Cheese', 'mozzarella_cheese.png', 'mozzarella_cheeses.png', 3)
